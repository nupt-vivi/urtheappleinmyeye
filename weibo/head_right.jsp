      ...
      <table width="184" height="29" border="0" cellpadding="0" cellspacing="0" background="images/head_13.jpg">
        <tr>
          <td valign="top"><table width="146" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="23" height="24">&nbsp;</td>
                <td width="123" valign="bottom"><a href="head_disussList.jsp" class="head-01"><strong>公告</strong></a> <span class="style5 style1">[DISCUSS] </span></td>
              </tr>
          </table></td>
        </tr>
      </table>
      ...
      <table width="184" height="28" border="0" cellpadding="0" cellspacing="0" background="images/head_15.jpg">
        <tr>
          <td valign="top"><table width="146" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="23" height="24">&nbsp;</td>
                <td width="123" valign="bottom"><a href="mailto:****@***.com" class="head-01"><strong>邮箱</strong></a> <span class="style5 style1">[EMAIL] </span></td>
              </tr>
          </table></td>
        </tr>
      </table>
      ...
      <table width="184" height="106" border="0" cellpadding="0" cellspacing="0" background="images/head_22.jpg">
        <tr>
          <td><table width="135" height="30" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="10">&nbsp;</td>
              <td width="125"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" width="120" height="36"><param name="movie" value="<%=src%>">
                <param name="quality" value="high">
              
                <embed src="<%=src%>" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" width="120" height="36"></embed>
